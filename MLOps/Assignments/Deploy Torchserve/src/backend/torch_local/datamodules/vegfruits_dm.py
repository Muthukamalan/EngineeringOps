...
class LitVegFruitsDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        if stage == "fit":
            self.train_ds: DatasetFolder = DatasetFolder(
                root=self.train_dir,
                loader=custom_loader,
                is_valid_file=custom_check_image,
            ...
            self.valid_ds: DatasetFolder = DatasetFolder(
                root=self.valid_dir,
                loader=custom_loader,
                is_valid_file=custom_check_image,
                transform=torchvision.transforms.Compose(
            ...
            self.test_ds: DatasetFolder = DatasetFolder(
                root=self.test_dir,
                loader=custom_loader,
                is_valid_file=custom_check_image,
                transform=torchvision.transforms.Compose(
